...
<body>
    ...
    <main class="container" id="container">
        ...
        <form action="./functions/finaliserCommande.php" method="post" class=" rounded bg-light mt-1 mx-2 py-2 px-5" id="buyingForm">
            ...
            <div class="d-flex justify-content-around align-items-center mb-3 ">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="cardNumber" id="cardNumber" aria-describedby="numberMsg" placeholder="Enter numero de carte bancaire">
                </div>
                <div class="form-group">
