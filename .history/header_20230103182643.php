...
<form action="./header.php" method="get" class="d-flex">
    ...
    <div class="form-group">
      ...
      <input type="date" class="form-control" name="projection" placeholder="projection" value="">
    </div>
    <div class="form-group">
      <label for="movie-name" class="form-label mt-4">nom du film</label>
      <input type="text" class="form-control" name="movie-name" placeholder="entrez le nom du film">
    </div>
    <input type="submit" value="seb">
</form>