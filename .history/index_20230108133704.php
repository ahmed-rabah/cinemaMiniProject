...
<body>
    ...
    <main class="">
        ...
        <section class="d-flex justify-content-around flex-wrap mt-4 mx-5 bg-dark border border-3 border-primary shadow-lg p-3 mb-5 bg-white rounded p-2" id="films">
        </section>
    </main>
