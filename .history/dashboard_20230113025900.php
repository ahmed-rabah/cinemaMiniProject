...
<body class="bg-img">
        ...
        <main class="">
            <section class="d-flex justify-content-around flex-wrap mt-4 mx-5 bg-light border border-3 border-light rounded p-2" style="box-shadow: 0 0 2rem white;" id="programms">
                <ul class="nav nav-tabs w-100 justify-content-between" role="tablist">
