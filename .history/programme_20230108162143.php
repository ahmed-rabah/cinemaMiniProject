...
<html lang="en">
    ...
    <body>
        ...
        <main class="">
             <div class="grid">
                 <div>
                    <a href="./" class="fixedarrow bg-primary"><i class="uil uil-left-arrow-from-left bg-primary">Retour</i></a>
                    <img src="./images/zodiac.jpg" style="height:500px; width: 100%;" alt="">
                 </div>
                 <div>
                    <div class="d-flex justify-content-between p-2">
                        ...
                        <div class="inner-grid">
                            <h5>description </h5>  
                            <p class="">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod officiis eius natus nobis vitae similique. Quisquam praesentium rerum omnis ipsa?</p>
                        </div>
                        <div class="inner-grid">
                            <h5>Cast </h5>  
                        ...
                        <div class="inner-grid">
                            <h5>trailer</h5>  
                            <h6> <a href="https://www.youtube.com/watch?v=WR7cc5t7tv8" target="_blank">trailer</a></h6>
                        </div>
                </div>
             </div>
        </main>
