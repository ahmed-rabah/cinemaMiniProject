...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if(sizeof($erreursArr) > 0) {   
     function erreursTable($erreursArr){
        echo "<table class=\"table w-100 table-striped table-light table-hover\" style=\"position : absolute\">
...
<body class="bg-dark bg-opacity-25">
    ...
    if(sizeof($erreursArr) > 0):
        ?>
    <div class="toast show w-50" role="alert" aria-live="assertive" aria-atomic="true">
