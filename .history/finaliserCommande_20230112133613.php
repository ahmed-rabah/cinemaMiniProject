...
<body>
    ...
    <main class="container" id="container">
        ...
        <form action="./functions/commanderProcess.php" method="post" class="d-flex justify-content-around rounded bg-light mt-1 mx-2 py-2 px-5">
            ...
            <div class="form-group"><button type="submit" class="btn btn-success text-white"><strong>acheter</strong></button></div>
        </form>
    <?php } ?>
    </main>
