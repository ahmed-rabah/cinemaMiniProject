...
<?php
    ...
    //         ?> <div style="display : grid; grid-template-columns: 12vw 45vw 36vw;gap: 2rem; ">
    //         <img src="<?= $programme['photo'] ?>" class="grid-poto m-1"  alt="...">
    //         <div class="card-body text-center">
    //             <h4 class="card-title"><?= $programme['titre'] ?></h4>
    //             <h6  class="card-text"><?= $programme['libelle'] ?></h6>
    //             <h6  class="card-text m-1">projecté le <?= $programme['date_projection'] ?> à <?= $programme['heure_debut'] ?></h6>
    //             <p class="card-text"><?= $programme['resume'] ?></p>
