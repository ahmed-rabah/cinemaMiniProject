...
if($postMethod && isset($_POST["username"],$_POST["password"])){
    ...
    if($result&& password_verify($_POST["password"],$result['password'])){
            ...
            $_SESSION['expiration_date']=time()+86000;
            setcookie("username",$result['username'],time()+446474);
    }
    ...
    <form action="./signin.php" method="post" id="user_signin" autocomplete="off" class="p-1">
            <fieldset>
                <div class="form-group mt-2">
                    ...
                    <input type="text" class="form-control" name="username" aria-describedby="usernamedesc" id="username"  placeholder="Enter username"  value="<?php if($postMethod):  echo $username; else: echo ''; endif ?>">
                    <small id="usernamedesc" class="form-text"></small>
                </div>
                <div class="form-group mt-2">
                    <label for="password" class="form-label mt-1">Password</label>
                    <input type="password" class="form-control" name="password" aria-describedby="pwddesc" id="password" placeholder="Password"  value="<?php if($postMethod):  echo $password; else: echo ''; endif ?>">
