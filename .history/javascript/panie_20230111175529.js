...
async function getUserPanier(){
    ...
    if(response === false){
        ...
        response.forEach(produit => {
            ...
            <div class="card-body">
                <div class="d-flex">
                <img src="${produit[0].photo}" width="60px" height="60px">
                    <div>
                        <p class="card-title  m-0">le ${produit[0].date_projection} à ${produit[0].heure_debut}</p>
                        <p class="card-text m-0">prix_unitaire : ${produit[0].prix_unitaire}</p>
                        <p class="card-text m-0">tickets disponible : ${produit[0].ticketsDisponible}</p>
                    </div>
                </div>
