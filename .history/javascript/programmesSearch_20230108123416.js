...
//    console.log("./functions/programmesSearch.php?genre="+genre+"&annee="+annee+"&movie="+movie+"&projection="+projection);
    getProgrammes(genre,annee,projection,movie).then(programmes=>{
        ...
        // </div>
            ...
            <div class="text-center pe-5">Désolé, nous n'avons pas réussi à trouver de programmes correspondant aux critères donnés. Veuillez affiner votre recherche ou utiliser des termes de recherche différents.</div>
          </div>`;
        }
