...
async function updateproductCart(product,status){
    ...
    if(connected && updated === false){
        msg=`<div class="alert alert-danger alert-dismissible fade show w-75" role="alert" id="myAlert">
        ${reponse}
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
      </div>`;
      cartItem.insertAdjacentHTML('beforebegin',msg);
    }else{
        msg=`<div class="alert alert-success alert-dismissible fade show w-75" role="alert" id="myAlert">
        ${reponse}
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>`;
        cartItem.insertAdjacentHTML('beforebegin',msg);
