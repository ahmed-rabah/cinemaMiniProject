...
//    console.log("./functions/programmesSearch.php?genre="+genre+"&annee="+annee+"&movie="+movie+"&projection="+projection);
    getProgrammes(genre,annee,projection,movie).then(programmes=>{
        ...
        // </div>
            ...
            programmesSection.innerHTML =`<div class="alert alert-danger d-flex align-items-center w-100" role="alert">
            <svg class="bi flex-shrink-0 me-2" role="img" aria-label="danger:"><use xlink:href="#exclamation-triangle-fill"/></svg>
            <div class="text-center pe-3">Désolé, nous n'avons pas réussi à trouver de programmes correspondant aux critères donnés. Veuillez affiner votre recherche ou utiliser des termes de recherche différents.</div>
          </div>`;
        }
