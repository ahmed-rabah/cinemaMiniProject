...
panierBtn.addEventListener('click', () => {
    getUserPanier().then(data=>{
        console.log(data);
        cartDiv = `<div class="absoluteCart m-2 border border-dark">${data}</div>`;
        let body = document.querySelector('body');
        ...
        response.forEach(produit => {
            ...
            <div class="card-body">
                ...
                <div class="card-footer d-flex justify-content-between">
                        <div class="d-flex">
                        <span class="btn plus" data-idprogramme="${produit.idProgramme}"><i class="uil uil-minus-circle"></i></span>
                        ${produit.nbrPlace}
                        <span class="btn minus" data-idprogramme="${produit.idProgramme}"><i class="uil uil-plus-circle"></i></span>
                        </div>
