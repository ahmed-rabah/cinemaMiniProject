    ...
    getUserProduct().then(products=>{
        ...
        if(connected === false) {
            ...
            response.forEach(produit=>{
                let PDFgenerated = produit.PDFprinted ? " disabled" : ""; 
                content+=`<tr class="text-center">
                            ...
                            <td class="pt-5"><button type="button" class="btn btn-primary ${PDFgenerated}" onclick="generatePDF(${produit.id_user})">génerer reçu</button></td>
                        </tr>`;
            })
            content+=`  </tbody>
                        </table>`;
