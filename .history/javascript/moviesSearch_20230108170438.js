...
function moviesContent(movies){
    ...
    movies.forEach(movie=>{
        ...
        let enCoursdeProjection = movie.en_cours_de_projection;
        ...
        let cardObj=`  <div class="card my-2" style="width: 18rem;margin-right :2px;margin-left :2px;">
                    ...
                    <div class="card-body text-center">
                        ...
                        <h5  class="card-text m-0">en cours de projection : ${enCoursdeProjection} DH</h5>
                        <div class="d-flex justify-content-between">
                            <button class="btn btn-success me-2 addToCart">ajouter au panier</button>
                            <a href="./movie.php?idFilm=${idFilm}" class="btn btn-primary ms-1">voir plus</a>
                        </div>
                    </div>
                </div>`;
