        ...
        if(connected === false) {
            ...
            response.forEach(produit=>{
                content+=`<tr class="text-center">
                            ...
                            <td class="pt-5"><img src="${produit.photo}"width="100" height="100"></td>
                            <td class="pt-5"><h6>${produit.titre}</h6></td>
                            <td class="pt-5">le <strong>${produit.date_projection}</strong></td>
                            <td class="pt-5"> à <strong>${produit.heure_debut}</strong></td>
                            <td class="pt-5">${produit.num_salle}</td>
                            <td class="pt-5"><strong>${produit.nombre_places}</strong> ticket(s)</td>
                            <td class="pt-5">${produit.prix}</td>
                            <td class="pt-5"></td>
                        </tr>`;
            })
            content+=`  </tbody>
