        ...
        response.forEach(produit => {
            ...
            <div class="card-body">
                ...
                <div class="card-footer d-flex justify-content-between">
                        <div class="d-flex">
                        <span class="plus" data-idprogramme="${produit.idProgramme}"><i class="uil uil-minus-circle"></i>plus</span>
                        ${produit.nbrPlace}
                        <span class="minus" data-idprogramme="${produit.idProgramme}"><i class="uil uil-plus-circle"></i>minus</span>
                        </div>
