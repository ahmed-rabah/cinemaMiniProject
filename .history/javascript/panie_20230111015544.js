    ...
    addProduit(id).then(response=>{
       ...
       let msg="";
        ...
        if(!added){
            ...
            ${reponse}
            <button type="button" class="btn-close alertOut" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>`;
        }else{
        ...
        let btnCloseAlert=document.querySelector(".alertOut");
        ...
        btnCloseAlert.addEventListener('click',()=>{theAlert.outerHTML="";})
    })
