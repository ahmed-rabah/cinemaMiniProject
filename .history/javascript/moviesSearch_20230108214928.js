...
let moviesHeader = document.getElementById('movies');
...
if(accueil.classList.contains('active')){
    accueil.classList.remove('active');
}
if(!moviesHeader.classList.contains('active')){
    moviesHeader.classList.add('active');
}
