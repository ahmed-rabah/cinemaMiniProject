        ...
        response.forEach(produit => {
            ...
            <div class="card-body">
                ...
                <div class="card-footer d-flex justify-content-between align-items-center">
                        ...
                        <h6 class="btn plus" data-idprogramme="${produit.idProgramme}"><i class="uil uil-minus-circle fs-5 bg-success"></i></h6>
                        <h6> ${produit.nbrPlace} </h6>
                        <h6 class="btn minus" data-idprogramme="${produit.idProgramme}"><i class="uil uil-plus-circle fs-5 bg-danger"></i></h6>
                        </div>
