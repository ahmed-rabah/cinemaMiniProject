...
function cartItemInfos(produit,use){
    ...
    if(use==="sidebar"){
        ...
        <h4 class="card-title  m-0 fw-normal">le <strong>${produit[0].date_projection}</strong> à <strong>${produit[0].heure_debut}</strong></h4>
        <h4 class="card-text m-0 fw-normal">prix_unitaire :<strong> ${produit[0].prix_unitaire} DH</strong></h4>
        <h4 class="card-text m-0 fw-normal">tickets disponible :<strong> ${produit[0].ticketsDisponible}</strong> ticket(s)</h4>
        </div>
        </div>
        </div>        
        <div class="card-footer d-flex justify-content-between align-items-center p-1">
