...
//    console.log("./functions/programmesSearch.php?genre="+genre+"&annee="+annee+"&movie="+movie+"&projection="+projection);
    getProgrammes(genre,annee,projection,movie).then(programmes=>{
        ...
        // </div>
            ...
            programmesSection.innerHTML =`<div class="alert alert-danger" role="alert">
            Désolé, nous n'avons pas réussi à trouver de programmes correspondant aux critères donnés. Veuillez affiner votre recherche ou utiliser des termes de recherche différents.<a href="#" class="alert-link">an example link</a>. Give it a click if you like.
          </div>`;
        }
