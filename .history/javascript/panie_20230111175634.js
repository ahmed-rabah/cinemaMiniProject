        ...
        response.forEach(produit => {
            ...
            <div class="card-body">
                ...
                <img src="${produit[0].photo}" width="60px" height="66px">
                    <div>
                        <p class="card-title  m-0 fw-bold"">le ${produit[0].date_projection} à ${produit[0].heure_debut}</p>
                        <p class="card-text m-0 fw-bold"">prix_unitaire : ${produit[0].prix_unitaire} DH</p>
                        <p class="card-text m-0 fw-bold"">tickets disponible : ${produit[0].ticketsDisponible} ticket(s)</p>
                    </div>
                </div>
