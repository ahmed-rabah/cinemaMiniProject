...
function cartItemInfos(produit){
    return `<div class="card border-primary mb-2" style="max-width: 20rem;" id="cart${produit.idProgramme}">
    ...
    <div class="d-flex justify-content-center">
                        <img src="${produit[0].photo}" width="60px" height="66px">
                            ...
                            <h6 class="btn plus" onclick="updateproductCart(${produit.idProgramme},'minus')"><i class="uil uil-minus-circle fs-5 text-danger"></i></h6>
                                <h6> ${produit.nbrPlace} </h6>
                                <h6 class="btn minus" onclick="updateproductCart(${produit.idProgramme},'minus')"><i class="uil uil-plus-circle fs-5 text-success"></i></h6>
                                </div>
