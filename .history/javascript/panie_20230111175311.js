        ...
        response.forEach(produit => {
            ...
            <div class="card-body">
                ...
                <div class="card-footer d-flex justify-content-between align-items-center">
                        ...
                        <h3 class="btn plus" data-idprogramme="${produit.idProgramme}"><i class="uil uil-minus-circle"></i></h3>
                        <h6> ${produit.nbrPlace} </h6>
                        <h3 class="btn minus" data-idprogramme="${produit.idProgramme}"><i class="uil uil-plus-circle"></i></h3>
                        </div>
