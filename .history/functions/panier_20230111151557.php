...
if($_SERVER['REQUEST_METHOD'] == 'GET'){
    ...
    if(isset($_SESSION['user_id']) && !empty( $_SESSION['panier'])){
        ...
        foreach ($panier as $product) {
            ...
            $req = "SELECT  p.idProgramme as ProgrammeID,g.libelle,f.titre,p.date_projection,f.photo , p.heure_debut, p.ticketsDisponible, p.prix_unitaire FROM programme as p, film as f , genre as g WHERE p.idFilm= f.idFilm AND p.idProgramme =$idprogramme AND g.idGenre = f.idGenre";
