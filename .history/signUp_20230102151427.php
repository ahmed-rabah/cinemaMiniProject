        ...
        <form action="./signup.php" method="post" id="user_signup" autocomplete="off" novalidate>
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" name="password" aria-describedby="pwddesc" id="password" placeholder="Password" value="<?php if($postMethod):  echo $username; else: echo ''; endif ?>">
