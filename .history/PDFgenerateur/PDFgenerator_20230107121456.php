     ...
     if(!empty($_GET['id_produit']) && isset($_SESSION['user_id']) && empty($_SESSION['panier'])){
        ...
        try{
             $pdo->beginTransaction();
               ...
               WHERE prod.id_programme = prog.idProgramme AND prod.id_user=u.idUser AND u.idUser = $userid AND f.idGenre=g.idGenre AND prog.idFilm = f.idFilm AND prod.id_produit=$idproduit";
                $stmt=$pdo->query($req);
