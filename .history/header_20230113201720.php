  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse justify-content-between" id="navbarColor01">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link active" href="./index.php" id="accueil"><h6>accueil</h6>
            <span class="visually-hidden">(current)</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="./movies.php"  id="movies"><h6>les Films</h6></a>
        </li>
        <!--     <li class="nav-item">
          <a class="nav-link" href="./movies.php" ><h6>les salles de projection</h6></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="./contact.php"><h6>Contact</h6></a>
        </li> -->
      </ul>
      <?php
...
if(isset($_SESSION['user_id'])){ ?>
    <ul class="nav navbar" id="connected">
      ...
      <li><a href="./dashboard.php" class="btn btn-primary ms-3 "><span class="font-size"><i class="uil uil-user-circle"></i><strong class="fs-5"><?= $_SESSION['username'] ?></strong></span></a></li>
