...
<body>
    ...
    <main class="">
        ...
        <section class="d-flex justify-content-around flex-wrap mt-4 mx-5 bg-dark border border-3 border-light rounded p-2" style="box-shadow: 0 0 1rem black;" id="films">
        </section>
    </main>
