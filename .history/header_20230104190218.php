...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar" id="connected">
      <li><a href="./panier.php" class="btn btn-light me-2"><i class="uil uil-shopping-cart-alt ">panier d'achat</i></a></li>
      <li><a href="./dashboard.php" class="btn btn-primary ms-3 "><span class="account"><i class="uil uil-user-circle bg-light"></i>votre compte</span></a></li>
    </ul>
  </div>
</nav>
