...
<body>
    ...
    <main class="">
        ...
        <section class="d-flex justify-content-around flex-wrap mt-4 mx-5 bg-dark border border-3 border-primary rounded  p-2 shadow p-3 mb-5 bg-body-tertiary " id="films">
        </section>
    </main>
