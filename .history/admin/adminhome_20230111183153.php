...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="adminhome.php" class="w3-bar-item w3-button w3-padding w3-black"><i class="fa fa-user fa-fw"></i>  Mes infos</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-dashboard"></i> MODIFIER INFOS ADMIN</b></h5>
  </header>
...
// Requête SELECT pour récupérer les données de l'admin
...
<form method="post" action="update_admin.php"  autocomplete="off">
