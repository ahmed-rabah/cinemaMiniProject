...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="home2.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-camera fa-fw"></i>  films</a>
    <a href="programmehome.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-bullseye fa-fw"></i>  programmes</a>
    <a href="config.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-user fa-fw"></i>  Mes infos</a>
...
if (mysqli_num_rows($result) > 0) {
   ...
   while($row = mysqli_fetch_assoc($result)) {
      ...
      echo "<td>   <form action=\"filmedit.php\" method=\"post\"  style=\" display : inline;\">
      <input type=\"number\" name=\"idFilm\" required=\"required\" placeholder=\"idFilm\" value=\"".$row['idFilm']."\" style=\"display : none\"><input type=\"submit\" value=\"Modifier\"  style=\" display : inline;\"></form>
      <form action=\"film_delete.php\" method=\"post\" style=\" display : inline;\">
  <input type=\"number\" name=\"id\" required=\"required\" placeholder=\"id\"value=\"".$row['idFilm']."\" style=\"display : none\">  <input type=\"submit\"style=\"background-color:red;display: inline\" value=\"supprimer\">
  </form> 
      </td>";
      echo "</tr>";
    }
