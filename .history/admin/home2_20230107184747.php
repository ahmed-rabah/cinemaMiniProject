...
if (mysqli_num_rows($result) > 0) {
  ...
  <input type=\"number\" name=\"id\" required=\"required\" placeholder=\"id\"value=\"".$row['idFilm']."\" style=\"display : none\">  <input type=\"submit\"style=\"background-color:re;\" value=\"supprimer\">
  </form> 
      </td>";
      echo "</tr>";
    }
