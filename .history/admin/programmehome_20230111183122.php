...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="programmehome.php" class="w3-bar-item w3-button w3-padding w3-black"><i class="fa fa-bullseye fa-fw"></i>  programmes</a>
...
$sql = "SELECT p.idProgramme , p.date_projection , p.heure_debut , p.num_salle , p.ticketsDisponible , p.prix_unitaire , f.titre , p.idFilm FROM programme as p , film as f WHERE f.idFilm = p.idFilm";
...
if (mysqli_num_rows($result) > 0) {
   ...
   while($row = mysqli_fetch_assoc($result)) {
      ...
      echo "<td>" .$row["idFilm"]." - ". $row["titre"]. "</td>";
...
<body>
  ...
  <footer class="w3-container w3-padding-16 w3-light-grey">
    ...
    <h5><b><i class="fa fa-pencil"></i> MODIFIER  </b></h5>
     <form action="programmeedit.php" method="post">
  <input type="number" name="idProgramme" required="required" placeholder="idProgramme" ?>
  <style>
  <style>
form {
  width: 50%;
...
<h5><b><i class="fa fa-trash"></i> SUPPRIMER  </b></h5>
     <form action="programme_delete.php" method="post">
  <input type="number" name="idProgramme" required="required" placeholder="idProgramme" ?>
  <style>
  <style>
form {
...
<h5><b><i class="fa fa-book"></i> AJOUTER  </b></h5>
     <form action="programmeajout.php" method="post">
  <style>
  <style>
form {
  width: 50%;
