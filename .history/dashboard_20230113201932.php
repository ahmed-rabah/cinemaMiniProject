            ...
            <section class="d-flex justify-content-around flex-wrap mt-4 mx-5 bg-light border border-3 border-light rounded p-2" style="box-shadow: 0 0 2rem white;" id="dashboard">
                ...
                <div id="myTabContent" class="tab-content w-100 m-4">
                    ...
                    <div class="tab-pane fade active show bg-dark p-4 rounded" id="param" role="tabpanel">
                            <form action="./functions/updateParams.php" method="post"   class="p-5 w-50 m-auto bg-light rounded">
                                <fieldset>
                                    ...
                                    <div class="form-group mt-2">
                                        <label for="password" class="form-label mt-1">nouveau Password</label>
                                        <input type="password" class="form-control" name="password" aria-describedby="pwddesc" id="password" placeholder="nouveau Password"  value="">
                                        <small id="pwddesc" class="form-text"></small>
                                    </div>
                                    <div class="form-group mt-2">
                                        <label for="password" class="form-label mt-1">confirmer nouveau Password</label>
                                        <input type="password" class="form-control" name="password" aria-describedby="pwddesc" id="password" placeholder="confirmer nouveau Password"  value="">
                                        <small id="pwddesc" class="form-text"></small>
                                    </div>
