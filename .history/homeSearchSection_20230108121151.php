<main class="">
    ...
    <section class="d-flex justify-content-around flex-wrap mt-4 mx-5 bg-dark bg-opacity-25" id="films">
        <div class="card" style="width: 18rem;">
            <img src="./images/Up.jpg" class="card-img-top align-self-center m-1"style="height:18rem;width :17rem; " alt="...">
            <div class="card-body text-center">
                <h4 class="card-title">Zodiac <span style="font-size:0.8rem;">16-06-1947</span></h4>
