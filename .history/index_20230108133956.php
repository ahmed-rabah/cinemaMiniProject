...
<body>
    ...
    <main class="">
        ...
        <section class="d-flex justify-content-around flex-wrap mt-4 mx-5 bg-dark border border-3 border-light rounded p-2" style="box-shadow: 3px 3px 3px black;" id="films">
        </section>
    </main>
