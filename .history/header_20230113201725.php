...
if(isset($_SESSION['user_id'])){ ?>
    <ul class="nav navbar" id="connected">
      ...
      <li><a href="./dashboard.php" class="btn btn-primary ms-3 "><span class="font-size"><i class="uil uil-user-circle"></i><strong class="fs-6"><?= $_SESSION['username'] ?></strong></span></a></li>
