...
<body>
    ...
    <main class="container">
        ...
        <form action="./functions/commanderProcess.php" method="post">
                <div class="form-group">
                    ...
                    <small id="numberMsg" class="form-text text-muted">We'll never share your email with anyone else.</small>
                </div>
        </form>
    </main>
