...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar" id="connected">
      <li><a href="./panier.php" class="btn btn-light me-2"><span class="font-size"><i class="uil uil-shopping-cart-alt font-size ">panier d'achat</i></span></a></li>
      <li><a href="./dashboard.php" class="btn btn-primary ms-3 "><span class=""><i class="uil uil-user-circle font-size"></i>votre compte</span></a></li>
    </ul>
  </div>
</nav>
