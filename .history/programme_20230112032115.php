            ...
            ?> 
                 ...
                 <div>
                    <div class="d-flex justify-content-between p-2">
                        ...
                        <button class="btn btn-primary me-2 addToCart" onclick="addProduct($programme['idProgramme'])">ajouter au panier</button>
                    </div>
                        ...
                        <div class="inner-grid">
                            ...
                            <h5 class="">le <?= $programme['date_projection'] ?> à  <?= $programme['heure_debut'] ?></h5>
                        </div>
                        <div class="inner-grid">
