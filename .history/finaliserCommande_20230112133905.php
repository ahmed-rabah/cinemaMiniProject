...
<body>
    ...
    <main class="container" id="container">
        ...
        <form action="./functions/commanderProcess.php" method="post" class=" rounded bg-light mt-1 mx-2 py-2 px-5">
            ...
            <div class="d-flex justify-content-around align-items-center ">
                ...
                <div class="form-group pt-4"><button type="submit" class="btn btn-success text-white"><strong>acheter</strong></button></div>
            </div>
        </form>
    <?php } ?>
    </main>
